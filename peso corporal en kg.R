...
x_Desv5td<-sd(kilogramos);(x_Desv5td)
...
plot(kilogramos)
plot(kilogramos,main = "peso de estudiantes")
plot(kilogramos,
     main = "peso de estudiantes",
     type = "o")
...
hist(kilogramos,
     ...
     ylab = "frecuencias",
     main="peso de estudiantes en kilogramos",
     col = rainbow(8,0.75))
